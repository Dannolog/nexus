...
#   3. Kontakte/Ansprechpartner: Nexus ⇄ kontor, Nexus ⇄ ProjectEye (Protokoll:
...
TS_NODE_TRANSPILE_ONLY=1 node node_modules/ts-node/dist/bin.js --compiler-options "$OPT" prisma/sync-kontor-kontakte.ts
