...
export const RESOURCES: Record<string, Resource> = {
  ...
  suppliers: {
    ...
    columns: [
      ...
      { key: "shortCode", label: "Kürzel" },
      { key: "customerNumber", label: "Kundennr." },
      { key: "email", label: "E-Mail" },
      { key: "archived", label: "Archiviert" },
    ],
    fields: [
      ...
      { key: "email", label: "E-Mail", type: "email" },
      { key: "phone", label: "Telefon" },
      { key: "web", label: "Webseite" },
      { key: "customerNumber", label: "Unsere Kundennummer" },
      { key: "street", label: "Straße" },
      { key: "zip", label: "PLZ" },
      { key: "city", label: "Ort" },
      { key: "country", label: "Land" },
      { key: "addressFree", label: "Anschrift (frei)", type: "textarea" },
      { key: "category", label: "Warengruppe" },
