...
/** Moderne Line-Icons (Lucide-Stil), stroke = currentColor → erben die Textfarbe. */
const PATHS: Record<string, React.ReactNode> = {
  ...
  truck: (<><path d="M14 18V6a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h2" /><path d="M14 9h4l3 3v5a1 1 0 0 1-1 1h-1" /><circle cx="7.5" cy="18" r="2" /><circle cx="17.5" cy="18" r="2" /><path d="M9.5 18h6" /></>),
  ...
  "id-card": (<><rect width="20" height="14" x="2" y="5" rx="2" /><circle cx="8.5" cy="11" r="2.2" /><path d="M5.2 16.4a3.8 3.8 0 0 1 6.6 0" /><path d="M15 10h4" /><path d="M15 13.5h4" /></>),
};
